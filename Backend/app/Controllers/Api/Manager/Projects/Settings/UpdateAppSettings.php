...
class UpdateAppSettings extends PrivateController
{
    ...
    public function index(): ResponseInterface
    {
        ...
        $projects->update($app["id"], [
            ...
            "one_signal_id"   => esc($this->request->getJsonVar("one_signal_id")),
            "one_signal_rest" => esc($this->request->getJsonVar("one_signal_rest")),
        ]);
    ...
    private function update_validation_type(): array
    {
        return [
            ...
            "one_signal_id"   => [
                "label" => lang("Fields.field_149"),
                "rules" => "permit_empty|min_length[3]|max_length[500]"
            ],
            "one_signal_rest" => [
                "label" => lang("Fields.field_150"),
                "rules" => "permit_empty|min_length[3]|max_length[500]"
            ],
        ];
    }
