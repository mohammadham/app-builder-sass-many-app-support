...
class Subscribe extends PrivateController
{
    /**************************************************************************************
     * PUBLIC FUNCTIONS
     **************************************************************************************/
    ...
    {
        $subscribe_external_uid = esc($this->request->getGet("external_uid"));
        ...
        $subscribe = $subscribes
            ->where("is_disable", 0)
            ->where("subscribe_external_id", $subscribe_external_uid)
            ->first();
