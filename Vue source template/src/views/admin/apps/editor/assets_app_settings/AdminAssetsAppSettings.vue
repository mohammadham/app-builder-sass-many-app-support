...
export default {
  ...
  methods: {
    getIcons() {
      adminProjectsService.getLaunchIcons(this.$route.params.uid).then((res) => {
        const data = res.data;
    ...
    downloadIcon(name, type, index) {
      ...
      adminProjectsService.downloadIcon(this.$route.params.uid, name, type).then((res) => {
    ...
    uploadIcon(image) {
      ...
      adminProjectsService.uploadIcon(this.$route.params.uid, image).then((res) => {
        const data = res.data;
        this.android = data.icons.android;
        this.ios = data.icons.ios;
        this.isUpload = data.icons.upload;
