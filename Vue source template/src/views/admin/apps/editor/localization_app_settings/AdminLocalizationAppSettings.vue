...
export default {
  ...
  methods: {
    getLocalizationList() {
      this.loading = true;
      adminProjectsService.getLocalizations(this.$route.params.uid).then((res) => {
        const data = res.data;
    ...
    updateLocal() {
      ...
      adminProjectsService.updateLocalization(this.$route.params.uid, {
        id: this.dialog.id,
    ...
    refreshLocal(index) {
      ...
      adminProjectsService.refreshLocalization(this.$route.params.uid, index + 1).then((res) => {
        const data = res.data;
    ...
    uploadOfflineImage(image) {
      ...
      adminProjectsService.uploadOfflineImage(this.$route.params.uid, image).then((res) => {
        const data = res.data;
    ...
    uploadErrorImage(image) {
      ...
      adminProjectsService.uploadErrorImage(this.$route.params.uid, image).then((res) => {
        const data = res.data;
