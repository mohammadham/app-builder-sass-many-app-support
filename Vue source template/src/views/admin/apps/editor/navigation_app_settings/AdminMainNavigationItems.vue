...
export default {
  ...
  methods: {
    getItems() {
      adminProjectsService.getMainNavigation(this.$route.params.uid).then((res) => {
        this.list = res.data;
        this.loading = false;
      }).catch(e => {
    ...
    removeItem(index) {
      ...
      adminProjectsService.removeNavigationItem(id, "main").then(() => {
