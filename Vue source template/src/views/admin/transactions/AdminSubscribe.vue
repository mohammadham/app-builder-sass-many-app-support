    ...
    <v-row>
      ...
      <v-col md="12" sm="12" cols="12">
        <div class="border rounded">
          <v-list-item
            :to="`/admin/apps/${subscribe.app.uid}/main`"
            lines="two"
          >
        ...
        >
          <div v-for="(transaction) in list">
            ...
            >
              ...
              <v-list-item-subtitle>ID: {{ transaction.uid }} / {{ $tr('admin', 'key_116') }}: {{ transaction.external_uid }}</v-list-item-subtitle>
              <template v-slot:append>
                <v-list-item-action>
...
export default {
  ...
  methods: {
    getTransactionList() {
      ...
      adminSubscribeService.getSubscribe(this.$route.params.external_uid, this.offset).then((res) => {
        const data = res.data;
