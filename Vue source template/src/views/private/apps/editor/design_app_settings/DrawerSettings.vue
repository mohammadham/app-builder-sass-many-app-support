...
export default {
  ...
  methods: {
    updateSettings() {
      this.isUpdate = true;
      projectsService.updateDrawerSettings(this.$route.params.uid, {
        mode: this.mode,
        color: this.color,
        theme: this.theme,
    ...
    getDrawerSettings() {
      projectsService.getDrawerSettings(this.$route.params.uid).then((res) => {
        const data = res.data;
        this.mode = data.mode;
    ...
    uploadBackground(image) {
      ...
      projectsService.uploadDrawerBackground(this.$route.params.uid, image).then((res) => {
        const data = res.data;
    ...
    uploadLogo(image) {
      ...
      projectsService.uploadDrawerLogo(this.$route.params.uid, image).then((res) => {
        const data = res.data;
        this.logo = data.uri;
