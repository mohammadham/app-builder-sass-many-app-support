...
export default {
  ...
  methods: {
    getSplashDetail() {
      this.loading = true;
      projectsService.getSplashscreenSettings(this.$route.params.uid).then((res) => {
        const data = res.data;
    ...
    updateSplash() {
      this.isUpdate = true;
      projectsService.updateSplashScreenSettings(this.$route.params.uid, {
    ...
    uploadBackground(image) {
      ...
      projectsService.uploadSplashScreenBackground(this.$route.params.uid, image).then((res) => {
        const data = res.data;
    ...
    uploadLogo(image) {
      ...
      projectsService.uploadSplashScreenLogo(this.$route.params.uid, image).then((res) => {
        const data = res.data;
        this.logo = data.uri;
